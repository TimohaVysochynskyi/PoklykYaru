...
function $(e) {
    ...
    if (!s.allowTouchMove) return d(c.target).is(n.focusableElements) || (s.allowClick = !1), void(n.isTouched && (Object.assign(r, {
        startX: h,
        startY: f,
        currentX: h,
        currentY: f
...
class F {
    constructor() {
        ...
        const a = this;
        a.__swiper__ = !0, a.support = S(), a.device = y({
        ...
        const l = g({}, D, r);
        return a.params = g({}, l, _, t), a.originalParams = g({}, a.params), a.passedParams = g({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach((e => {

    ...
    <div className={css.container}>
      ...
      <div className={css.row}>
        ...
        <div className={css.col}>
          ...
          <p className={css.text}>
            Побратимство означає підтримку та взаємодопомогу. Суть чудово
            передає гасло: "Один за всіх і всі за одного!". Без побратимства
            інші цінності нічого не варті, тому стоїть на першому місці.
          </p>
          <p className={css.text}>
            Дисципліна – основа будь-якого порядку. Без неї виховання зводиться
            нанівець, а будь-яке заняття перетворюється на хаос. Дисципліна
            структуризує всю роботу і допомагає чітко слідувати до виконання
            мети.
          </p>
          <p className={css.text}>
            Патріотизм – риса відповідальної нації. Це повага та відданість
            рідній країні. Без виконання перших двох цінностей, не можна
            говорити про любов до України. Щоб досягти чогось високого, треба
            почати із взаємопідтримки і самодисципліни.
          </p>
          <p className={css.text}>

        ...
        <li className={css.item}>
          <div className={css.col}>
            ...
            <p className={css.text}>
              Організація «Поклик Яру» живе за рахунок людей, які вірять в нас
              та нашу справу, й самих членів команди. Монобаза — спосіб
              регулярно долучатися до розвитку «Поклик Яру» гривнею. Підтримуючи
              нас, ви вкладаєтесь у системне виховання відповідальної молоді.
              Обирайте зручний для вас рівень та підписуйтеся на щомісячний
